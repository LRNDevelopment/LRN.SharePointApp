...
public sealed class FolderSyncEngine
{
        ...
        CancellationToken ct)
    {
        ...
        foreach (var file in files)
        {
            ...
            // defensive: sometimes copied paths contain invisible unicode direction marks
            ...
            try
            {
                ...
                uploaded++;
                _log.LogInformation("Uploaded: {Local} -> {Remote}", fileName, remotePath);
            ...
            {
                _log.LogError(ex, "Upload failed: {Local} -> {Remote}", fileName, remotePath);
